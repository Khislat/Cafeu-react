...
const MenuBookSection: React.FC = () => {
  ...
  return (
    <section
      className="menu-book tabs position-re dark-mode pb-90"
      data-scroll-index="1"
    >
          ...
          <div className="col-md-12">
            <div className="tab-links mb-45">
              <ul className="text-center">
                <li
                  className={`item-link ${isTabOpen.tab1 ? "current" : ""}`}
                  data-tab="tab-1"
                  onClick={() => handleTabToggle("tab1")}
                >
                  {" "}
                  Starters{" "}
                </li>
                <li
                  className={`item-link ${isTabOpen.tab2 ? "current" : ""}`}
                  data-tab="tab-2"
                  onClick={() => handleTabToggle("tab2")}
                >
                  {" "}
                  Mains{" "}
                </li>
                <li
                  className={`item-link ${isTabOpen.tab3 ? "current" : ""}`}
                  data-tab="tab-3"
                  onClick={() => handleTabToggle("tab3")}
                >
                  {" "}
                  Salads{" "}
                </li>
                <li
                  className={`item-link ${isTabOpen.tab4 ? "current" : ""}`}
                  data-tab="tab-4"
                  onClick={() => handleTabToggle("tab4")}
                >
                  {" "}
                  Desserts{" "}
                </li>
                <li
                  className={`item-link ${isTabOpen.tab5 ? "current" : ""}`}
                  data-tab="tab-5"
                  onClick={() => handleTabToggle("tab5")}
                >
                  {" "}
                  Wine{" "}
                </li>
        ...
        <div className="row">
          <div className="col-12" data-aos="fade-up" data-aos-duration="2000">
            <div className="position-re">
              <div
                className={`tab-content ${isTabOpen.tab1 ? "current" : ""}`}
                id="tab-1"
              >
                <MenuTabPane
                  firstStartIndex={0}
              ...
              <div
                className={`tab-content ${isTabOpen.tab2 ? "current" : ""}`}
                id="tab-2"
              >
                <MenuTabPane
                  firstStartIndex={8}
              ...
              <div
                className={`tab-content ${isTabOpen.tab3 ? "current" : ""}`}
                id="tab-3"
              >
                <MenuTabPane
                  firstStartIndex={0}
              ...
              <div
                className={`tab-content ${isTabOpen.tab4 ? "current" : ""}`}
                id="tab-4"
              >
                <MenuTabPane
                  firstStartIndex={4}
              ...
              <div
                className={`tab-content ${isTabOpen.tab5 ? "current" : ""}`}
                id="tab-5"
              >
                <MenuTabPane
                  firstStartIndex={12}
