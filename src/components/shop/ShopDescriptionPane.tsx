    ...
    <div className="blog-details">
      <div className="post-des">
        <p className="service-des mb-3">
          ...
          suspendisse ultrices gravida. Risus commodo viverra maecenas accums
          lacus vel facilisis. rorem ipsum dolor sit amet, consectetur
          adipiscing elit, sed do eiusmod tempor incididun labore et dolore
      ...
      <h4 className="service-heding mb-3">Special Food Recipes for Special</h4>

      <p className="service-des">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
        tempor incididunt ut labore dolore magna aliqua. Quis ipsum suspendisse
        ultrices gravida. Risus commodo viverra maecenas accums lacus vel
